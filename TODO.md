...
* ~~Implementar notificacions de límit de pla (avisos al 80/90% i bloqueig al 100%).~~ ✅ backend / ⚠️ frontend pendent de verificar UI
...
* Actualitzar documentació a `definitions/` i `docs-site/` amb els nous límits i comportament d'errors. ⚠️ Falta: leave server, server invitations, S3/streaming limits a OVERVIEW.md
* Afegir tests d'integració per quotes d'S3 i LiveKit (free/pro/enterprise). ✅
* Tests unitaris Rust de crypto (kyber, aes_gcm, channel_keys). ❌
